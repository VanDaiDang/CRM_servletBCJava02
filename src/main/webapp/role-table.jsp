...
<head>
    ...
    <link rel="stylesheet" href="./css/role-table.css">
                            ...
                            <table class="table" id="example">
                                ...
                                <c:forEach var="item" items="${listRoles}">
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#" type="button" class="btn btn-sm btn-primary btn-updateRole" role-update = "${item.id} "data-toggle="modal" data-target="#myModal" >Sửa</a>
                                            <!-- Modal -->
                                                        ...
                                                        <div class="modal-body">
                                                            <form>
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control btn-nameRoleUpdate" name="nameUpdate" id="name-update"  placeholder="Tên quyền mới" >
                                                                </div>
                                                                <div class="form-group">
                                                                    <label> Mô tả </label>
                                                                    <input type="text" class="form-control btn-descRoleUpdate" name="descUpdate" id="desc-update" placeholder="Mô tả" >
                                                                </div>
                                                                <div>
                                            ...
                                            <a href="#" class="btn btn-sm btn-danger btn-deleteRole" id-role = "${item.id}">Xóa</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                                </tbody>
...
<script>
    $(document).ready(function (){
        $(".btn-updateRole").click(function (){
            let id = parseInt($(this).attr("role-update"));
            $(".btn-submitUpdate").click(function (){
                let name = document.getElementById("name-update").value;
                let desc = document.getElementById("desc-update").value;
                $.ajax({
                    method: "GET",
                    url: "http://localhost:8080/MY_CRM_PROJECT/api/role/update?id="+id+"&nameUpdate="+name+"&descriptionUpdate="+desc,
                    success: function (rs) {
                        if (rs.success === true){
                            setTimeout(function (){
                                location.reload();
